...
const animations = {
 ...
 Orbit: () => (
   <div className="relative w-24 h-24">
     ...
     <motion.div className="absolute w-4 h-4" style={{ top: '50%', left: '50%', marginLeft: '-8px', marginTop: '-8px' }} animate={{ rotate: 360 }} transition={{ duration: 3, repeat: Infinity, ease: "linear" }}>
 ...
 // 39. Liquid Button
 LiquidButton: () => (
   <motion.button className="relative px-8 py-4 bg-[#3B82F6] text-black font-bold rounded-none overflow-hidden" whileHover="hover" whileTap={{ scale: 0.95 }} variants={{ hover: { scale: 1.05 } }}>
     <motion.div className="absolute inset-0 bg-white/30" initial={{ x: '-100%' }} variants={{ hover: { x: '100%' } }} transition={{ duration: 0.5 }} />
 ...
 // 52. Perspective Card
 PerspectiveCard: () => (
   <motion.div className="w-32 h-40 bg-[#3B82F6] rounded-none" style={{ transformPerspective: 1000, rotateY: 0, rotateX: 0 }} whileHover={{ rotateY: 15, rotateX: -10 }} transition={{ type: "spring", stiffness: 300 }} />
 ),
 ...
 // 55. Mask Reveal
 MaskReveal: () => (
   <motion.div className="relative w-32 h-32 rounded-none overflow-hidden" whileHover="hover">
     <div className="absolute inset-0 bg-gradient-to-br from-[#3B82F6] to-[#E2E8F0]" />
     <motion.div className="absolute inset-0 bg-black" initial={{ x: 0 }} variants={{ hover: { x: '100%' } }} transition={{ duration: 0.5 }} />
   </motion.div>
 ),
...
const animationDemos: AnimationDemo[] = [
 ...
 { id: '55', name: 'Mask Reveal', description: 'Sliding mask reveal', category: 'Hover', difficulty: 'Easy', component: <animations.MaskReveal />, dependencies: ['framer-motion'], code: `<motion.div whileHover="hover">\n  <motion.div\n    initial={{ x: 0 }}\n    variants={{ hover: { x: '100%' } }}\n    transition={{ duration: 0.5 }}\n  />\n</motion.div>` },
